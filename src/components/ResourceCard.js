  ...
  return (
    ...
    >
      <CardContent
        ...
        markdown={cardResourceId == 'ta' && content.length > 0 ? content : markdown}// Adding content value to maintain edit changes even when switching between markdown and html views on tA.
      />
    </Card>
  )
}
