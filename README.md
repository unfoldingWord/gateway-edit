...
- last deployed on GitHub pages: [deployed JS-Docs](https://unfoldingword.github.io/gateway-edit/gateway-edit/index.html)
- current local: [local JS-Docs](./docs/gateway-edit/index.html)
